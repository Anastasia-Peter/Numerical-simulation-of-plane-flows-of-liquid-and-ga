...
# Результаты
В вашей папке автоматически создадутся файлы с результатами. Открыть данные файлы можно в программе Tecplot. В случае получения полей у вас будут такие прекрасные картинки: ( как пример приведено поле продольной компоненты скорости, полученное при решении уравнений Прандтля)
